...
struct cnum32 cnum32_intersect(struct cnum32 a, struct cnum32 b, bool *two_arcs);
void cnum32_intersect_with(struct cnum32 *dst, struct cnum32 src, bool *two_arcs);
void cnum32_intersect_with_urange(struct cnum32 *dst, u32 min, u32 max, bool *two_arcs);
void cnum32_intersect_with_srange(struct cnum32 *dst, s32 min, s32 max, bool *two_arcs);
...
struct cnum64 cnum64_intersect(struct cnum64 a, struct cnum64 b, bool *two_arcs);
void cnum64_intersect_with(struct cnum64 *dst, struct cnum64 src, bool *two_arcs);
void cnum64_intersect_with_urange(struct cnum64 *dst, u64 min, u64 max, bool *two_arcs);
void cnum64_intersect_with_srange(struct cnum64 *dst, s64 min, s64 max, bool *two_arcs);
