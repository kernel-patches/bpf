...
event_btf_ids_read(struct file *filp, char __user *ubuf, size_t cnt, loff_t *ppos)
{
	...
	/*
	 * For module BTF, resolve_btfids stores module-local ids that need
	 * base+local relocation. Then follow FUNC -> FUNC_PROTO so the
	 * user-visible id points at args with names.
	 */
