...
__weak bool arch_uprobe_is_register(uprobe_opcode_t *insn, int nbytes, void *data)
{
	return is_swbp_insn(insn);
}
...
__weak int arch_uprobe_verify_opcode(struct page *page, unsigned long vaddr, uprobe_opcode_t *new_opcode,
				     void *data)
{
...
int uprobe_write_opcode(struct arch_uprobe *auprobe, struct mm_struct *mm,
			unsigned long vaddr, uprobe_opcode_t *insn, int nbytes, void *data)
{
	struct uprobe *uprobe;
	...
	is_register = arch_uprobe_is_register(insn, nbytes, data);
