		     ...
		     bpfptr_t uattr_common, unsigned int size_common)
{
	...
	case BPF_MAP_FREEZE:
		...
		break;
	case BPF_PROG_LOAD:
		log_true_size = size >= offsetofend(union bpf_attr, log_true_size) ?
			uattr.user + offsetof(union bpf_attr, log_true_size) : NULL;
	...
	case BPF_RAW_TRACEPOINT_OPEN:
		...
		break;
	case BPF_BTF_LOAD:
		log_true_size = size >= offsetofend(union bpf_attr, btf_log_true_size) ?
			uattr.user + offsetof(union bpf_attr, btf_log_true_size) : NULL;
