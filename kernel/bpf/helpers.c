 ...
 * designed for use with cgroup v2. Although technically possible, using
 * it with cgroup v1 is uncommon and may not produce meaningful results.
 * For cgroup v1, prefer using bpf_task_get_cgroup1.
 */
