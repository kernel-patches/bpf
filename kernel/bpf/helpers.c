...
__bpf_kfunc int bpf_copy_from_user_mm(void *dst__uninit, u32 dst__sz,
 ...
 * @dst__uninit:     Destination address, in kernel space
 ...
 * is zeroed if an attempted copy cannot be completed in full or if unsupported
 * flags are supplied.
 *
