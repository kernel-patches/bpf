...
{
	return (reg->umin_value > reg->umax_value ||
 ...
 * when the branch is taken, if it produces ill-formed register bounds, it must
 * mean that the branch is dead.
 */
...
only_true:
	/* If there is a range bounds violation in *any* of the abstract values
	 * in either reg_states in the FALSE branch (i.e. false_reg1,
	 * false_reg2), the FALSE branch must be dead. Only TRUE branch will be
	 * taken.
	 */
	return 1;
...
only_false:
	/* If there is a range bounds violation in *any* of the abstract values
	 * in either reg_states in the TRUE branch (i.e. true_reg1,
	 * true_reg2), the TRUE branch must be dead. Only TRUE branch will be
	 * taken.
	 */
	return 0;
}
