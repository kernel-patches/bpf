 ...
 * - these auxiliary macros cast the key and value parameters of the
 *   functions are cast to either long or long*, so the user does not
 *   have to specify the casts explicitly;
