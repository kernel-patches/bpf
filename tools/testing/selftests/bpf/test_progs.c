...
{
	// open_memstream (from stdio_hijack_init) ensures that log_bug is terminated by a null byte.
	// Yet in parralel mode, log_buf will be NULL if there is no message.
	if(log_cnt) {
