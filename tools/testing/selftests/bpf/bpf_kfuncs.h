...
void bpf_landlock_put_ruleset(
	const struct bpf_landlock_ruleset *ruleset) __ksym __weak;
/*
 * Description
 ...
 *  have been obtained from a Landlock ruleset map lookup. This accepts the
 *  usual landlock_restrict_self() flags except
 *  LANDLOCK_RESTRICT_SELF_EXECTIME, which is implicit for this helper.
 * Returns
