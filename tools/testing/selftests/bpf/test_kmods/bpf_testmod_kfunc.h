...
int bpf_kfunc_multi_st_ops_test_1_impl(struct st_ops_args *args,
				       void *aux__prog) __ksym;

struct prog_test_member *bpf_kfunc_get_default_trusted_ptr_test(void) __ksym;
void bpf_kfunc_put_default_trusted_ptr_test(
	const struct prog_test_member *trusted_ptr) __ksym;
