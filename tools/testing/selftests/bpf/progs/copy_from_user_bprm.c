...
int BPF_PROG(check_exec_args, struct linux_binprm *bprm, int ret)
{
	...
	/* this is the total size of args and envs staring from bprm->p */
	...
	/* env0 is at prm->p + sizeof(arg0) + sizeof(arg1) */
	...
	/* env1 is at prm->p + sizeof(arg0) + sizeof(arg1) + sizeof(env0) */
