...
{
	int key = 10;
	struct elem val1 = {.k = 100, .hello = {0}};
	struct elem val2 = {.k = 200, .hello = {0}};
	struct elem *e;
	int ret;
...
{
	int key = 11;
	struct elem val1 = {.k = 111, .hello = {0}};
	struct elem val2 = {.k = 222, .hello = {0}};
	struct elem *e;
	int ret;
