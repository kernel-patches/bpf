 ...
 * call limit enforcement matches with expectations when tailcalls are preceeded
 ...
 * preceeded with two bpf2bpf calls, and the two subprogs are traced by fentry.
 */
 ...
 * preceeded with two bpf2bpf calls, and the two subprogs are traced by both
 * fentry and fexit.
 */
 ...
 * the tail call limit enforcement matches with expectations when tailcalls are
 * preceeded with two bpf2bpf calls in fentry.
 */
