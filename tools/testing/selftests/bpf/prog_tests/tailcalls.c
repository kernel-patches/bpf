 ...
 *
 *         tailcallee0 -> subprog0 with tailcalling tailcallee0
 * entry <
 *         tailcallee1 -> subprog1 with tailcalling tailcallee1
 */
 ...
 * call limit enforcement matches with expectations:
 *
 *                                 subprog0 with jmp_table0 to tailcallee
 * entry --tailcall-> tailcallee <
 *                                 subprog1 with jmp_table1 to tailcallee
 */
