...
__naked __maybe_unused unsigned long uprobe_regs_change_ip_1(void)
{
	asm volatile (
		"movq $0xc0ffee, %rax\n"
		"ret\n"
...
__naked __maybe_unused unsigned long uprobe_regs_change_ip_2(void)
{
	asm volatile (
		"movq $0xdeadbeef, %rax\n"
		"ret\n"
...
static void regs_ip(void)
{
	...
	skel->links.test_regs_change = bpf_program__attach_uprobe_opts(skel->progs.test_regs_change_ip,
							    -1,
							    "/proc/self/exe",
							    0 /* offset */,
							    &uprobe_opts);
