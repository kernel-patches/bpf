...
void test_global_percpu_data_init(void)
{
	...
	ASSERT_EQ(init_data->struct_data.i, init_value.struct_data.i, "struct_data.i");
	ASSERT_EQ(init_data->struct_data.nums[6], init_value.struct_data.nums[6], "struct_data.nums[6]");
	...
	ASSERT_EQ(skel->percpu->struct_data.i, init_value.struct_data.i, "struct_data.i");
	ASSERT_EQ(skel->percpu->struct_data.nums[6], init_value.struct_data.nums[6], "struct_data.nums[6]");
