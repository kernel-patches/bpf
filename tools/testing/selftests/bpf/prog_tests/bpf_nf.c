...
static void test_bpf_nf_ct(int mode)
{
	...
	ASSERT_EQ(skel->data->test_ct_zone_alloc_entry, 0, "Test for alloc new entry in specified ct zone");
	ASSERT_EQ(skel->data->test_ct_zone_insert_entry, 0, "Test for insert new entry in specified ct zone");
	ASSERT_EQ(skel->data->test_ct_zone_succ_lookup, 0, "Test for successful lookup in specified ct_zone");
	ASSERT_EQ(skel->bss->test_enoent_bad_ct_zone_lookup, -ENOENT, "Test ENOENT for failed lookup in different ct zone");
