...
static struct btf *mk_loc_btf(void)
{
	...
	btf__add_loc_param_value(btf, 2);
	btf__add_loc_param_value(btf, 0xfffffff0);
	...
	btf__add_locsec_loc(btf, 3, 8, 64);
...
static void test_loc_dump(const char *btf_path)
{
	const char expected[] =
		"[1] INT 'int' size=4 bits_offset=0 nr_bits=32 encoding=SIGNED\n"
		"[2] FUNC_PROTO '(anon)' ret_type_id=1 vlen=4\n"
		"\t'arg1' type_id=1\n"
		"\t'arg2' type_id=1\n"
		"\t'arg3' type_id=1\n"
		"\t'arg4' type_id=1\n"
