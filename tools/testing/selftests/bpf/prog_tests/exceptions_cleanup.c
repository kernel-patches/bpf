...
static void test_shapes(void)
{
	...
	/*
	 * A pad that branches on the constant the walker leaves in r0: the
	 * precision request for it must not cross the unwind edge.
	 */
	if (test__start_subtest("pad_branches_on_r0"))
