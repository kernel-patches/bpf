...
static void test_shapes(void)
{
	...
	/*
	 * A pad that reloads from and writes to its own frame's stack, which
	 * is what a compiler-generated pad does and what a JIT addressing the
	 * frame through the stack pointer gets wrong.
	 */
