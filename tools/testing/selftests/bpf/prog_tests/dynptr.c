...
static struct {
	...
	{"data_slice_missing_null_check1", "invalid mem access 'dynptr_mem_or_null'"},
	{"data_slice_missing_null_check2", "invalid mem access 'dynptr_mem_or_null'"},
	...
	{"dynptr_from_mem_invalid_api",
		"Unsupported reg type fp for arg type ARG_PTR_TO_MEM with DYNPTR_TYPE_LOCAL set"},
