...
static void __test_hash(void)
{
	__test(create_hash());
	printf("test_%s:PASS\n", __func__);
}

static void __test_percpu_hash(void)
{
	__test(create_percpu_hash());
	printf("test_%s:PASS\n", __func__);
}

static void __test_hash_prealloc(void)
{
	__test(create_hash_prealloc());
	printf("test_%s:PASS\n", __func__);
}

static void __test_percpu_hash_prealloc(void)
{
	__test(create_percpu_hash_prealloc());
	printf("test_%s:PASS\n", __func__);
}

static void __test_lru_hash(void)
{
	__test(create_lru_hash());
	printf("test_%s:PASS\n", __func__);
}

static void __test_percpu_lru_hash(void)
{
...
void test_map_percpu_stats(void)
{
	__test_hash();
	__test_percpu_hash();
	__test_hash_prealloc();
	__test_percpu_hash_prealloc();
	__test_lru_hash();
	__test_percpu_lru_hash();
}
