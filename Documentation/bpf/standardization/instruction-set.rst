...
.. table:: Arithmetic instructions
  ...
  SUB    0x1    0        dst -= src
  MUL    0x2    0        dst \*= src
  UHMUL  0x2    1        unsigned high-half multiply (``ALU64`` only)
  SHMUL  0x2    2        signed high-half multiply (``ALU64`` only)
...
* ``MUL``: ``offset`` selects a high-half multiply variant (see below).
