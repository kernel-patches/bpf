...
/*
 * Size of the area the throw site spills the throwing frame's own BPF
 * callee-saved registers into, laid out exactly as this prologue's spill of
 * its caller's -- r12, rbx, r13, r14, r15 -- so that
 * arch_bpf_run_cleanup_pad() reads either one the same way.
 */
