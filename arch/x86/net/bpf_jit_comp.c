			   ...
			   void *image, void *rw_image)
{
	...
	if (p->aux->use_tail_call_run_ctx) {
		...
		/* mov qword ptr [rbp - ctx_tc_run_ctx_off], rdi */
		EMIT3_off32(0x48, 0x89, 0xBD, ctx_tc_run_ctx_off);
		/* Make rdi as tcc_ptr */
		/* lea rdi, [rbp - ctx_tcc_off] */
		EMIT3_off32(0x48, 0x8D, 0xBD, ctx_tcc_off);
		/* Clear tail_call_cnt */
		/* mov dword ptr [rdi], 0 */
		EMIT2_off32(0xC7, 0x07, 0x00);
		/* Cache tcc_ptr */
		/* mov qword ptr [rbp - ctx_tc_run_ctx_off+8], rdi */
		EMIT3_off32(0x48, 0x89, 0xBD, ctx_tc_run_ctx_off+8);
		/* Update rdi as tail call run ctx */
		/* lea rdi, [rbp - ctx_tc_run_ctx_off] */
		EMIT3_off32(0x48, 0x8D, 0xBD, ctx_tc_run_ctx_off);
	}
